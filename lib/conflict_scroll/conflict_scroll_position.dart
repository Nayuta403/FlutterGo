...
/// @author 俊达
/// @date   2020/8/10 5:36 PM
/// @desc   滑动位置信息
class ConflictScrollPosition extends ScrollPosition
    implements ScrollActivityDelegate {
  final ConflictScrollCoordinator coordinator; // 协调器
  ...
  void absorb(ScrollPosition other) {
    super.absorb(other);
    if (other is! ConflictScrollPosition) {
      goIdle();
      return;
    }
    activity.updateDelegate(this);
    final ConflictScrollPosition typedOther = other as ConflictScrollPosition;
