...
import 'conflict_scroll_coordinator.dart';
...
/// @desc   滑动控制器
class ConflictScrollController extends ScrollController {
  final ConflictScrollCoordinator coordinator;

  /// 为可滚动小部件创建一个控制器。
  /// `initialScrollOffset`和`keepScrollOffset`的值不能为null。
  ConflictScrollController(
    this.coordinator, {
  ...
  ConflictScrollPosition get position {
